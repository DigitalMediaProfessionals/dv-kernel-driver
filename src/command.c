...
#ifdef _TVGEN_
	tvgen_mem_table(&table, table_base_addr, table_buf_size);
#endif
...
#ifdef _TVGEN_
	tvgen_phi_ocp_i(prev_addr, TVGEN_DEV_R5SHM, 0x0);
	tvgen_phi_ocp_i(prev_size / 8, TVGEN_DEV_R5SHM, 0x4);
    tvgen_phi_ocp_i(0x1, TVGEN_DEV_R5SHM, 0x8);
    tvgen_phi_ocp_i(IPI_MASK, TVGEN_DEV_R5IPI, IPI_TRIG_OFFSET);
#endif
}
